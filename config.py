...
AI_PROVIDERS = [
# LLMs de pago comentados - solo usaremos open source
    # {
    #     "name": "Groq",
    #     "type": AIModel.GROQ,
    ...
    #     "free_tier": False
    # },
    # LLMs open source activos — orden de prioridad: DeepSeek V2 > Mistral > Llama > Qwen
    {
        "name": "Ollama DeepSeek V2 (Local)",
        "type": AIModel.OLLAMA,
